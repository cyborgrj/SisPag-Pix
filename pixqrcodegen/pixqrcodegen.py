...
class Payload():
    def __init__(self, nome, apresentante, chavepix, valor, cidade, txtId):
        ...
        self.cidade = cidade
        self.txtId = txtId
        self.apresentante = apresentante
        ...
        self.apresentante_tam = len(self.apresentante)
        ...
        if self.apresentante_tam <= 9:
            self.apresentante_tam = f'0{self.apresentante_tam}{self.apresentante}'
        else:
            self.apresentante_tam = f'{self.apresentante_tam}{self.apresentante}'
        ...
        self.nomeApresentante = f'02{self.apresentante_tam}'
        self.merchantAccount = f'26{len(self.merchantAccount_tam)+len(self.nomeApresentante)}{self.merchantAccount_tam}'
    ...
    def gerarPayload(self):
        self.payload = f'{self.payloadFormat}{self.merchantAccount}{self.nomeApresentante}{self.merchantCategCode}{self.transactionCurrency}{self.transactionAmount}{self.countryCode}{self.merchantName}{self.merchantCity}{self.addDataField}{self.crc16}'
        print(self.gerarCrc16(self.payload))
...
if __name__ == '__main__':
    ...
    Payload('Nome Sobrenome', 'apresentante', '12345678900', '1.00', 'Cidade Ficticia', 'LOJA01').gerarPayload()