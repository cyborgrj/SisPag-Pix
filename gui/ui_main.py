...
"background: transparent;")
        ...
        self.tableConsultaPix.setEditTriggers(QAbstractItemView.AnyKeyPressed|QAbstractItemView.DoubleClicked|QAbstractItemView.EditKeyPressed|QAbstractItemView.SelectedClicked)
        self.tableConsultaPix.setTabKeyNavigation(False)
        self.tableConsultaPix.setProperty("showDropIndicator", False)
        self.tableConsultaPix.setDragDropOverwriteMode(False)
