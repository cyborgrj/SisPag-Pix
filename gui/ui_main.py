...
"}")
        ...
        self.campo_apresentante.setGeometry(QRect(230, 50, 531, 41))
        font3 = QFont()
        ...
        self.campo_valor.setGeometry(QRect(270, 178, 301, 41))
        ...
        self.txt_id_pix.setGeometry(QRect(221, 250, 301, 43))
        font4 = QFont()
...
"padding: 5px;")
        ...
        self.txt_moeda.setGeometry(QRect(221, 180, 55, 43))
...
"padding: 5px;")
        ...
        self.btn_gerar_qrcode.setGeometry(QRect(230, 330, 161, 41))
        font5 = QFont()
        ...
        self.btn_limpar_campos.setGeometry(QRect(460, 330, 161, 41))
...
"background: transparent;")
        ...
        self.somente_numeros.setGeometry(QRect(450, 110, 201, 43))
...
"background:transparent;")
        self.campo_txt_id = QLineEdit(self.frame_10)
        self.campo_txt_id.setObjectName(u"campo_txt_id")
        self.campo_txt_id.setGeometry(QRect(220, 260, 221, 47))
...
"background: transparent;")
        ...
        self.tableConsultaPix.setEditTriggers(QAbstractItemView.NoEditTriggers)
        self.tableConsultaPix.setAlternatingRowColors(True)
        self.tableConsultaPix.setSelectionMode(QAbstractItemView.SingleSelection)
        self.tableConsultaPix.setSelectionBehavior(QAbstractItemView.SelectRows)
...
"background:transparent")
        ...
        QWidget.setTabOrder(self.filtro_data_consultapix, self.tableConsultaPix)
        QWidget.setTabOrder(self.tableConsultaPix, self.btn_inser_num_interno_consulta_pix)
        ...
        QWidget.setTabOrder(self.filtro_dia_alterapix, self.tableBuscaEAutorizaPix)
        QWidget.setTabOrder(self.tableBuscaEAutorizaPix, self.combo_tema)
