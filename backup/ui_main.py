...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(890, 540)
        MainWindow.setMinimumSize(QSize(890, 540))
        MainWindow.setMaximumSize(QSize(890, 540))
        ...
        self.top_center_frame.setStyleSheet(u"background-color: rgb(45, 45, 45);\n"
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(36, 36, 36, 255), stop:1 rgba(80, 80, 80, 255));\n"
"\n"
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(25, 26, 33, 255), stop:1 rgba(40, 42, 54, 255));")
        ...
        self.label_titulo.setGeometry(QRect(-54, -11, 881, 61))
        font = QFont()
...
"background: transparent;")
        ...
        self.frame_left_base.setMaximumSize(QSize(45, 600))
...
"}")
        ...
        self.GerarQrCode = QPushButton(self.frame_left_menu)
        self.GerarQrCode.setObjectName(u"GerarQrCode")
        sizePolicy = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.GerarQrCode.sizePolicy().hasHeightForWidth())
        self.GerarQrCode.setSizePolicy(sizePolicy)
        self.GerarQrCode.setMinimumSize(QSize(250, 40))
        self.GerarQrCode.setMaximumSize(QSize(250, 40))
        self.GerarQrCode.setFont(font1)
        self.GerarQrCode.setFocusPolicy(Qt.NoFocus)
        self.GerarQrCode.setLayoutDirection(Qt.LeftToRight)
        self.GerarQrCode.setStyleSheet(u"	padding: 6px 9px;")
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/save.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.GerarQrCode.setIcon(icon1)
        self.GerarQrCode.setIconSize(QSize(25, 25))

        self.verticalLayout_3.addWidget(self.GerarQrCode)
        ...
        self.ConsultaPgto = QPushButton(self.frame_left_menu)
        self.ConsultaPgto.setObjectName(u"ConsultaPgto")
        self.ConsultaPgto.setMinimumSize(QSize(250, 40))
        self.ConsultaPgto.setMaximumSize(QSize(250, 40))
        self.ConsultaPgto.setFont(font1)
        self.ConsultaPgto.setFocusPolicy(Qt.NoFocus)
        self.ConsultaPgto.setStyleSheet(u"	padding: 6px 9px;")
        icon3 = QIcon()
        icon3.addFile(u":/icons/icons/refresh-ccw.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.ConsultaPgto.setIcon(icon3)
        self.ConsultaPgto.setIconSize(QSize(25, 25))

        self.verticalLayout_3.addWidget(self.ConsultaPgto)

        self.CadastrarUsuario = QPushButton(self.frame_left_menu)
        self.CadastrarUsuario.setObjectName(u"CadastrarUsuario")
        self.CadastrarUsuario.setMinimumSize(QSize(250, 40))
        self.CadastrarUsuario.setMaximumSize(QSize(250, 40))
        self.CadastrarUsuario.setFont(font1)
        self.CadastrarUsuario.setFocusPolicy(Qt.NoFocus)
        self.CadastrarUsuario.setStyleSheet(u"padding: 6px 10px;")
        icon4 = QIcon()
        icon4.addFile(u":/icons/icons/user-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.CadastrarUsuario.setIcon(icon4)
        self.CadastrarUsuario.setIconSize(QSize(25, 25))

        self.verticalLayout_3.addWidget(self.CadastrarUsuario)

        self.AutorizarPix = QPushButton(self.frame_left_menu)
        self.AutorizarPix.setObjectName(u"AutorizarPix")
        self.AutorizarPix.setMinimumSize(QSize(250, 40))
        self.AutorizarPix.setMaximumSize(QSize(250, 40))
        self.AutorizarPix.setFont(font1)
        self.AutorizarPix.setFocusPolicy(Qt.NoFocus)
        self.AutorizarPix.setStyleSheet(u"padding: 6px 7px;")
        icon5 = QIcon()
        icon5.addFile(u":/icons/icons/check-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.AutorizarPix.setIcon(icon5)
        self.AutorizarPix.setIconSize(QSize(25, 25))

        self.verticalLayout_3.addWidget(self.AutorizarPix)

        self.verticalSpacer = QSpacerItem(20, 240, QSizePolicy.Minimum, QSizePolicy.Fixed)
...
"	\n"
"	background-color: rgb(98, 113, 143);\n"
"	\n"
...
"}")
        ...
        self.stackedWidget.setGeometry(QRect(-10, 10, 851, 470))
        ...
        self.campo_apresentante.setGeometry(QRect(60, 97, 531, 41))
        font3 = QFont()
        ...
        self.campo_apresentante.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"color:rgb(255,255,255);\n"
"border: none;\n"
...
"padding: 5px;")
        ...
        self.campo_valor.setGeometry(QRect(100, 161, 301, 41))
        self.campo_valor.setFont(font3)
        self.campo_valor.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"color:rgb(255,255,255);\n"
"border: none;\n"
"border-bottom:3px solid rgba(255,255,255,150);\n"
"padding: 5px;")
        ...
        self.txt_id_pix.setGeometry(QRect(51, 231, 301, 43))
        font4 = QFont()
...
"padding: 5px;")
        ...
        self.btn_limpar_campos.setGeometry(QRect(427, 300, 161, 41))
        ...
        self.campo_usuario_atual.setGeometry(QRect(60, 30, 531, 31))
        self.campo_usuario_atual.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 15pt \"MS Shell Dlg 2\"")
        self.stackedWidget.addWidget(self.page_gerar)
        self.page_imprimir = QWidget()
        self.page_imprimir.setObjectName(u"page_imprimir")
        self.txt_buscar = QLabel(self.page_imprimir)
        self.txt_buscar.setObjectName(u"txt_buscar")
        self.txt_buscar.setGeometry(QRect(50, 180, 351, 43))
        self.txt_buscar.setFont(font4)
        self.txt_buscar.setStyleSheet(u"padding: 5px;")
        self.campo_txt_id = QLineEdit(self.page_imprimir)
        self.campo_txt_id.setObjectName(u"campo_txt_id")
        self.campo_txt_id.setGeometry(QRect(60, 230, 221, 47))
        self.campo_txt_id.setFont(font3)
        self.campo_txt_id.setStyleSheet(u"")
        self.campo_txt_id.setMaxLength(45)
        self.btn_imprimir = QPushButton(self.page_imprimir)
        self.btn_imprimir.setObjectName(u"btn_imprimir")
        self.btn_imprimir.setGeometry(QRect(60, 60, 191, 41))
        self.btn_imprimir.setFont(font5)
        self.btn_imprimir.setStyleSheet(u"")
        self.txt_obs = QLabel(self.page_imprimir)
        self.txt_obs.setObjectName(u"txt_obs")
        self.txt_obs.setGeometry(QRect(280, 230, 391, 43))
        font6 = QFont()
...
"font: 14pt \"MS Shell Dlg 2\";")
        self.btn_buscar_imprimir = QPushButton(self.page_imprimir)
        self.btn_buscar_imprimir.setObjectName(u"btn_buscar_imprimir")
        self.btn_buscar_imprimir.setGeometry(QRect(60, 290, 191, 41))
        ...
        self.label_5 = QLabel(self.page_consultar)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(10, -10, 841, 471))
        self.label_5.setFont(font4)
        self.label_5.setStyleSheet(u"")
        self.tableConsultaPix = QTableWidget(self.page_consultar)
        if (self.tableConsultaPix.columnCount() < 7):
            self.tableConsultaPix.setColumnCount(7)
        __qtablewidgetitem = QTableWidgetItem()
        __qtablewidgetitem.setTextAlignment(Qt.AlignCenter);
        self.tableConsultaPix.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        __qtablewidgetitem1.setTextAlignment(Qt.AlignCenter);
        self.tableConsultaPix.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        __qtablewidgetitem2.setTextAlignment(Qt.AlignCenter);
        self.tableConsultaPix.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        __qtablewidgetitem3 = QTableWidgetItem()
        __qtablewidgetitem3.setTextAlignment(Qt.AlignCenter);
        self.tableConsultaPix.setHorizontalHeaderItem(3, __qtablewidgetitem3)
        ...
        self.tableConsultaPix.setGeometry(QRect(30, 40, 801, 371))
        font7 = QFont()
        ...
        font7.setWeight(50)
        self.tableConsultaPix.setFont(font7)
        self.tableConsultaPix.setStyleSheet(u"font: 10pt \"MS Shell Dlg 2\";")
        self.tableConsultaPix.setAlternatingRowColors(True)
        self.pushButton = QPushButton(self.page_consultar)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(60, 420, 121, 31))
        ...
        self.frame.setGeometry(QRect(31, 97, 509, 281))
        ...
        self.frame_2.setGeometry(QRect(31, 21, 511, 51))
        ...
        font8.setWeight(50)
        self.combo_tipo_usuario.setFont(font8)
...
"font: 15pt \"MS Shell Dlg 2\"")
        ...
        self.frame_3.setGeometry(QRect(31, 380, 233, 57))
        ...
        self.frame_8.setGeometry(QRect(10, -10, 841, 471))
        self.frame_8.setStyleSheet(u"")
        self.frame_8.setFrameShape(QFrame.StyledPanel)
        self.frame_8.setFrameShadow(QFrame.Raised)
        self.frame_7 = QFrame(self.frame_8)
        self.frame_7.setObjectName(u"frame_7")
        self.frame_7.setGeometry(QRect(16, 20, 811, 41))
        ...
        self.combo_limite_altera.setGeometry(QRect(670, 8, 131, 33))
        ...
        self.combo_filtro_alterapix.setGeometry(QRect(520, 8, 131, 33))
        ...
        self.frame_4.setGeometry(QRect(0, 71, 831, 401))
        self.frame_4.setFrameShape(QFrame.StyledPanel)
        self.frame_4.setFrameShadow(QFrame.Raised)
        self.tableWidget = QTableWidget(self.frame_4)
        self.tableWidget.setObjectName(u"tableWidget")
        self.tableWidget.setGeometry(QRect(20, 0, 805, 341))
        self.btn_buscar_imprimir_4 = QPushButton(self.frame_4)
        self.btn_buscar_imprimir_4.setObjectName(u"btn_buscar_imprimir_4")
        self.btn_buscar_imprimir_4.setGeometry(QRect(20, 350, 160, 35))
        self.btn_buscar_imprimir_4.setFont(font5)
        self.btn_buscar_imprimir_4.setFocusPolicy(Qt.NoFocus)
        self.btn_buscar_imprimir_4.setStyleSheet(u"")
        self.btn_buscar_imprimir_5 = QPushButton(self.frame_4)
        self.btn_buscar_imprimir_5.setObjectName(u"btn_buscar_imprimir_5")
        self.btn_buscar_imprimir_5.setGeometry(QRect(190, 350, 160, 35))
        self.btn_buscar_imprimir_5.setFont(font5)
        self.btn_buscar_imprimir_5.setFocusPolicy(Qt.NoFocus)
        self.btn_buscar_imprimir_5.setStyleSheet(u"")
        self.tableBuscaEAutorizaPix = QTableWidget(self.frame_4)
        if (self.tableBuscaEAutorizaPix.columnCount() < 7):
            self.tableBuscaEAutorizaPix.setColumnCount(7)
        __qtablewidgetitem7 = QTableWidgetItem()
        __qtablewidgetitem7.setTextAlignment(Qt.AlignCenter);
        self.tableBuscaEAutorizaPix.setHorizontalHeaderItem(0, __qtablewidgetitem7)
        __qtablewidgetitem8 = QTableWidgetItem()
        __qtablewidgetitem8.setTextAlignment(Qt.AlignCenter);
        self.tableBuscaEAutorizaPix.setHorizontalHeaderItem(1, __qtablewidgetitem8)
        __qtablewidgetitem9 = QTableWidgetItem()
        __qtablewidgetitem9.setTextAlignment(Qt.AlignCenter);
        self.tableBuscaEAutorizaPix.setHorizontalHeaderItem(2, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        __qtablewidgetitem10.setTextAlignment(Qt.AlignCenter);
        self.tableBuscaEAutorizaPix.setHorizontalHeaderItem(3, __qtablewidgetitem10)
        __qtablewidgetitem11 = QTableWidgetItem()
        __qtablewidgetitem11.setTextAlignment(Qt.AlignCenter);
        self.tableBuscaEAutorizaPix.setHorizontalHeaderItem(4, __qtablewidgetitem11)
        __qtablewidgetitem12 = QTableWidgetItem()
        __qtablewidgetitem12.setTextAlignment(Qt.AlignCenter);
        self.tableBuscaEAutorizaPix.setHorizontalHeaderItem(5, __qtablewidgetitem12)
        __qtablewidgetitem13 = QTableWidgetItem()
        __qtablewidgetitem13.setTextAlignment(Qt.AlignCenter);
        self.tableBuscaEAutorizaPix.setHorizontalHeaderItem(6, __qtablewidgetitem13)
        self.tableBuscaEAutorizaPix.setObjectName(u"tableBuscaEAutorizaPix")
        self.tableBuscaEAutorizaPix.setGeometry(QRect(20, 0, 801, 341))
        font9 = QFont()
        ...
        font9.setWeight(50)
        self.tableBuscaEAutorizaPix.setFont(font9)
        self.tableBuscaEAutorizaPix.setStyleSheet(u"")
        self.tableBuscaEAutorizaPix.setDefaultDropAction(Qt.IgnoreAction)
        self.tableBuscaEAutorizaPix.setAlternatingRowColors(False)
        self.tableBuscaEAutorizaPix.setSelectionMode(QAbstractItemView.SingleSelection)
        self.tableBuscaEAutorizaPix.setSelectionBehavior(QAbstractItemView.SelectRows)
        self.tableBuscaEAutorizaPix.setSortingEnabled(True)
...
"font: 10pt \"MS Shell Dlg 2\";")
        ...
        font10.setWeight(50)
        self.btn_set_big_font.setFont(font10)
...
"font: 18pt \"MS Shell Dlg 2\";")
        ...
        self.frame_5.setGeometry(QRect(20, 0, 831, 201))
        ...
        self.combo_tema.setGeometry(QRect(190, 80, 131, 33))
        ...
        self.btn_aplicar_tema.setGeometry(QRect(340, 80, 141, 33))
...
"background:transparent")
        ...
        self.frame_9.setGeometry(QRect(20, 220, 831, 201))
        self.frame_9.setFrameShape(QFrame.StyledPanel)
        self.frame_9.setFrameShadow(QFrame.Raised)
        self.label_6 = QLabel(self.frame_9)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(10, 70, 361, 51))
...
"background:transparent")
        ...
        self.label_creditos.setFont(font11)
        ...
        QWidget.setTabOrder(self.campo_apresentante, self.campo_valor)
        ...
        QWidget.setTabOrder(self.btn_limpar_campos, self.Sair)
        QWidget.setTabOrder(self.Sair, self.btn_imprimir)
        QWidget.setTabOrder(self.btn_imprimir, self.campo_txt_id)
        QWidget.setTabOrder(self.campo_txt_id, self.btn_buscar_imprimir)
        QWidget.setTabOrder(self.btn_buscar_imprimir, self.combo_tipo_usuario)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.GerarQrCode.setText(QCoreApplication.translate("MainWindow", u"  Gerar QrCode", None))
        self.Imprimir.setText(QCoreApplication.translate("MainWindow", u"  Imprimir o QrCode", None))
        self.ConsultaPgto.setText(QCoreApplication.translate("MainWindow", u"  Consultar Pagamento", None))
        self.CadastrarUsuario.setText(QCoreApplication.translate("MainWindow", u"  Cadastro de Usu\u00e1rios", None))
        self.AutorizarPix.setText(QCoreApplication.translate("MainWindow", u"  Liberar Pix", None))
        ...
        self.campo_txt_id.setPlaceholderText(QCoreApplication.translate("MainWindow", u"TxT ID: ", None))
        ...
        ___qtablewidgetitem = self.tableConsultaPix.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"ID Pix", None));
        ___qtablewidgetitem1 = self.tableConsultaPix.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Apresentante", None));
        ___qtablewidgetitem2 = self.tableConsultaPix.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Valor", None));
        ___qtablewidgetitem3 = self.tableConsultaPix.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Caixa", None));
        ___qtablewidgetitem4 = self.tableConsultaPix.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Data/Hora", None));
        ...
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MainWindow", u"Alterado por", None));
        ...
        self.btn_buscar_imprimir_4.setText(QCoreApplication.translate("MainWindow", u"Liberar Pix", None))
        self.btn_buscar_imprimir_5.setText(QCoreApplication.translate("MainWindow", u"Cancelar", None))
        ___qtablewidgetitem7 = self.tableBuscaEAutorizaPix.horizontalHeaderItem(0)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MainWindow", u"ID Pix", None));
        ___qtablewidgetitem8 = self.tableBuscaEAutorizaPix.horizontalHeaderItem(1)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", u"Apresentante", None));
        ___qtablewidgetitem9 = self.tableBuscaEAutorizaPix.horizontalHeaderItem(2)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"Valor", None));
        ___qtablewidgetitem10 = self.tableBuscaEAutorizaPix.horizontalHeaderItem(3)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", u"Caixa", None));
        ___qtablewidgetitem11 = self.tableBuscaEAutorizaPix.horizontalHeaderItem(4)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("MainWindow", u"Data/Hora", None));
        ___qtablewidgetitem12 = self.tableBuscaEAutorizaPix.horizontalHeaderItem(5)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", u"Status", None));
        ___qtablewidgetitem13 = self.tableBuscaEAutorizaPix.horizontalHeaderItem(6)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("MainWindow", u"Liberado", None));
        ...
        self.combo_tema.setItemText(0, QCoreApplication.translate("MainWindow", u"Drcl Night", None))
        self.combo_tema.setItemText(1, QCoreApplication.translate("MainWindow", u"Drcl Claro", None))
        self.combo_tema.setItemText(2, QCoreApplication.translate("MainWindow", u"Mono Escuro", None))
        self.combo_tema.setItemText(3, QCoreApplication.translate("MainWindow", u"Mono Claro", None))
